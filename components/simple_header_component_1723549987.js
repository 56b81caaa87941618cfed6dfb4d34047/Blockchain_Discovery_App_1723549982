...
Vue.component("simple_header_component_1723549987", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-pink-600 bg-opacity-30 backdrop-filter backdrop-blur-lg border-gray-200 py-2.5 dark:bg-purple-900 dark:bg-opacity-30 shadow-lg rounded-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-white lg:p-0 dark:text-white hover:text-pink-300 transition-colors duration-300" aria-current="page">Latest Cryptocurrency News</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-purple-500 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-300 lg:p-0 dark:text-white lg:dark:hover:text-pink-300 dark:hover:bg-purple-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-300">Emerging Blockchain Projects</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-purple-500 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-300 lg:p-0 dark:text-white lg:dark:hover:text-pink-300 dark:hover:bg-purple-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-300">Market Trends and Analysis</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-white border-b border-gray-100 hover:bg-purple-500 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-300 lg:p-0 dark:text-white lg:dark:hover:text-pink-300 dark:hover:bg-purple-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 transition-colors duration-300">Innovative DApp Discoveries</a></li>
                    </ul>
                </div>
            </div>
        </nav>
